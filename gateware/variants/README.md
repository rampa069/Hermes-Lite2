...
| Variant | Device | RX | TX | CW | ATU | UART | Fan | AK4951 | HL2LINK | ExtDbg | Envelope | Receiver | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [hl2b2_main](hl2b2_main/) | EP4CE22 | 4 | 1 | 1 | 0 | 1 | 1 | 0 | 1 | 0 | - | NCO | Beta 2 hardware |
...
| [hl2b5up_15ce](hl2b5up_15ce/) | EP4CE15 | 2 | 1 | 1 | 1 | 1 | 1 | 0 | 1 | 0 | - | NCO | Smaller 15K LE FPGA |
| [hl2b5up_bypassversa](hl2b5up_bypassversa/) | EP4CE22 | 4 | 1 | 1 | 1 | 1 | 1 | 0 | 1 | 1 | ROM | NCO | Bypass Versa clocking |
| [hl2b5up_ak4951v3](hl2b5up_ak4951v3/) | EP4CE22 | 4 | 1 | 2 | 0 | 1 | 1 | 1 | 0 | 0 | ROM | NCO | AK4951 v3 codec |
| [hl2b5up_ak4951v3_yaesu](hl2b5up_ak4951v3_yaesu/) | EP4CE22 | 4 | 1 | 2 | 0 | 0 | 1 | 1 | 0 | 0 | ROM | NCO | AK4951 v3 + Yaesu bandV |
| [hl2b5up_ak4951v4](hl2b5up_ak4951v4/) | EP4CE22 | 4 | 1 | 2 | 1 | 1 | 0 | 1 | 0 | 0 | ROM | NCO | AK4951 v4 + ATU_AK4951 |
| [hl2b5up_ak4951v4_yaesu](hl2b5up_ak4951v4_yaesu/) | EP4CE22 | 4 | 1 | 2 | 1 | 0 | 1 | 1 | 0 | 0 | ROM | NCO | AK4951 v4 + Yaesu + ATU_AK4951 |
...
| ExtDbg | `HL2_EXTENDED_DEBUG_RESP` - extended debug response packets |
| Envelope | `CW_ENV_ROM` - CW envelope ROM table (ROM) or none (-) |
...
The 19-bit `tx_cwlevel` counter ramps from 0 to `MAX_CWLEVEL` (0x4D800) at the system clock rate (~4.1 ms). The upper 8 bits index the ROM; they only reach 0x4D800 >> 11 = 155, so the whole sin² rise sits in entries 0..155 (156..255 hold the peak). The peak is 0x4D80, the same maximum as the linear ramp, so CW output power is unchanged. The table is generated by `rtl/radio_openhpsdr1/cw_env_rom.py`.
