...
#set_input_delay -clock clock_76p8MHz -max 3 [get_ports {io_link_*}]
#set_input_delay -clock clock_76p8MHz -min 2 [get_ports {io_link_*}]
set_output_delay -clock clock_76p8MHz -max 3 [get_ports {io_link_tx[*]}]
set_output_delay -clock clock_76p8MHz -min 2 [get_ports {io_link_tx[*]}]
set_input_delay -clock clock_76p8MHz -max 3 [get_ports {io_link_rx[*]}]
set_input_delay -clock clock_76p8MHz -min 2 [get_ports {io_link_rx[*]}]
#set_false_path -from [get_ports {io_link_rxn}]
...
set_output_delay -clock clock_76p8MHz -max 3 [get_ports {io_db1_2}]
set_output_delay -clock clock_76p8MHz -min 2 [get_ports {io_db1_2}]
set_false_path -to   [get_ports {io_db1_3}]
set_false_path -from [get_ports {io_db1_4}]
set_false_path -from [get_ports {io_db1_5}]
set_output_delay -clock clock_76p8MHz -max 3 [get_ports {io_db1_6}]
set_output_delay -clock clock_76p8MHz -min 2 [get_ports {io_db1_6}]
